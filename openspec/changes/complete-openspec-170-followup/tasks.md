...
- [ ] **Task 3.1**: `sdflow-spec-review/SKILL.md:298` 扩展 amendment 写回范围到四件套
  - Requirement: amendment-bidirectional-coherence
  - 验证：读 SKILL.md 确认 amendment 明确覆盖 proposal/design/specs/tasks，引用双向原则

## 4. 收尾

- [ ] **Task 4.1**: roadmap 回写——更新 `openspec/roadmaps/openspec-1.7.0-followup/roadmap.md` 的 P2/P3/Q2 状态
