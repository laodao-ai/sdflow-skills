...
- [ ] T232/T238/T240/T241 仅在归档 artifact 证据真实存在时关闭
- [ ] T233–T237/T242 仅在本 change 对应实现与测试通过时关闭，T234 的 A/B 输入订正有独立证据
- [ ] T132 仍为 OPEN，T239 仍为未处理，逐 ID 断言可阻止误关
- [ ] 主规格、delta、台账状态与证据备注互相一致，重建或校验不会丢失逐票语义
