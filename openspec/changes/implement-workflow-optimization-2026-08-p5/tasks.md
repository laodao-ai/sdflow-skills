...
- [ ] 1.2 `sdflow-init/assets/workflow/tools/tests/test_anchor_lint.py`：正例 / 缺锚 /
...
- [ ] 2.3 [spec-review-amendment] 「一次一问」残留规范面同步（design De 修订版三处）：
...
- [ ] 3.1 审计通道建立：`{change_dir}/audit/skill-doc1-audit.md` 骨架（**15** 节
...
- [ ] 3.3 其余 8 个 SKILL 审计（≤500 行者）[spec-review-amendment]：过删除测试，
