...
- [ ] [spec-review-amendment] 补收尾节点唯一约束（多张全阻塞票须声明互相 Blocked-by）
...
- [ ] [spec-review-amendment] 同步更新 frontmatter `description`（`SKILL.md:6`）中"串行"表述
- [ ] [spec-review-amendment] 同步更新正文引言段（`SKILL.md:155-158`）中"串行"表述
- [ ] [spec-review-amendment] ~~dispatch prompt `git add` 按文件名 MUST~~ 降为建议性最佳实践
