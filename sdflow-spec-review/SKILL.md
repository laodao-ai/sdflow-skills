...
<!-- sdflow:async-branch:start —— 站点无关的 host 调度段。与 sdflow-code-review/SKILL.md 同名 marker 段 MUST 字节相同（hack/check_async_branch_parity.py 机械守）。站点枚举 / context 构造 / reuse-guard 门控 / declared-sites 计算 MUST 留在本 marker 之外 -->
